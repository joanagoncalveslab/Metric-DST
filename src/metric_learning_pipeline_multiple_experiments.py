...
if platform.system() == 'Windows':
    webDriveFolder = "W:/staff-umbrella/JGMasters/2122-mathijs-de-wolf/multiple_experiments/feature_sets/"
    outputFolder = ""
else:
    webDriveFolder = "/tudelft.net/staff-umbrella/JGMasters/2122-mathijs-de-wolf/multiple_experiments/feature_sets/"
    outputFolder = "/tudelft.net/staff-umbrella/JGMasters/2122-mathijs-de-wolf/multiple_experiments/output/"
...
def init_argparse() -> argparse.ArgumentParser:
    ...
    parser.add_argument('--exp1', type=str, default=None)
...
if __name__ == '__main__':
    ...
    trainDataPath = webDriveFolder + f"{args.exp1}_{args.exp2}_{args.cancer}_train_seq_128.csv"
    unlabeledDatapath = webDriveFolder + f"unknown_repair_{args.unlabeled}_{args.cancer}_seq_128.csv"
    testDatapath = webDriveFolder + f"{args.exp1}_{args.exp2}_{args.cancer}_test_seq_128.csv"
    ...
    with open(outputFolder + 'settings.txt', 'a') as f:
        f.write('\n'.join([
            ...
            'experiment 1: '+str(args.exp1),
            'experiment 2: '+str(args.exp2),
            'unlabeled: '+str(args.unlabeled),
        ]))
