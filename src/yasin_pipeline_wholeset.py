...
def init_argparse() -> argparse.ArgumentParser:
    ...
    parser.add_argument('--dataset', "-d", choices=['fire', 'pistachio', 'pumpkin', 'raisin', 'rice', 'abalone', 'yeast', 
    ...
    parser.add_argument("--model", "-m", choices=['supervised', 'balanced_semi_supervised', 'true_semi_supervised', 'diversity', 'all'], default='diversity')
...
if __name__ == '__main__':
    ...
    X, y = ld.load_dataset(args.dataset, test=False)
    #X, y = shuffle(X.copy(), y.copy(), random_state=args.seed)
