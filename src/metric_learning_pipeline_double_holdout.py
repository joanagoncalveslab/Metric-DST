...
if platform.system() == 'Windows':
    ...
    holdoutexperimentFolder = "W:/staff-umbrella/JGMasters/2122-mathijs-de-wolf/holdout_experiments/double_holdout/"
    outputFolder = ""
else:
    webDriveFolder = "/tudelft.net/staff-umbrella/JGMasters/2122-mathijs-de-wolf/feature_sets/"
    holdoutexperimentFolder = "/tudelft.net/staff-umbrella/JGMasters/2122-mathijs-de-wolf/holdout_experiments/double_holdout/"
...
def load_data(cancer, fold):
    dataPath = holdoutexperimentFolder + f"train_seq_128_{cancer}_{fold}.csv"
    unlabeledDatapath = webDriveFolder + f"unknown_repair_cancer_{cancer}_seq_128.csv"
    testDatapath = holdoutexperimentFolder + f"test_seq_128_{cancer}_{fold}.csv"
    ...
    return dataset, unlabeled_dataset, test_dataset
...
if __name__ == '__main__':
    ...
    for fold in range(total_number_of_folds):
        ...
        dataset, unlabeled_dataset, test_dataset = load_data(args.cancer, fold)
        gc.collect()
