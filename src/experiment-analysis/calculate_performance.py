...
performance = pd.read_csv("/tudelft.net/staff-umbrella/JGMasters/2122-mathijs-de-wolf/output/experiment-BRCA-0.01-noMiner-contrastive-exclude-partially-40-10-PARP1/performance.csv", index_col=0)
test_performance = pd.read_csv("/tudelft.net/staff-umbrella/JGMasters/2122-mathijs-de-wolf/output/experiment-BRCA-0.01-noMiner-contrastive-exclude-partially-40-10-PARP1/performance-testset.csv", index_col=0)
